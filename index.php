	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : 0895606104423 </li>
				</ul>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/bakulpulsa.jpg" alt="" />
			</li>
			<li>
			...
			<li>
				<img src="images/fastest.jpg" alt="" />
			</li>
		</ul>
	<!-- //main-slider -->
